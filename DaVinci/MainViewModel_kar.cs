...
namespace DaVinci
{
    class MainViewModel_kar : ViewModelBase_car
    {
        ...
        {
            Images = new List<BitmapImage>(global::DaVinci.Im.It_artists.car.ContentProvider_car.Instance.GetDefaultPictures());
            SetNextImage();
            IsInitialized = true;
        }
