...
namespace DaVinci
{
    class MainViewModel_maz : ViewModelBase_maz
    {
        ...
        {
            Images = new List<BitmapImage>(global::DaVinci.Im.It_artists.maz.ContentProvider_maz.Instance.GetDefaultPictures());
            SetNextImage();
            IsInitialized = true;
        }
