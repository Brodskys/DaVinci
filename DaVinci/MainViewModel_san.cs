...
namespace DaVinci
{
    class MainViewModel_san : ViewModelBase_san
    {
        ...
        {
            Images = new List<BitmapImage>(global::DaVinci.Im.It_artists.san.ContentProvider_san.Instance.GetDefaultPictures());
            SetNextImage();
            IsInitialized = true;
        }
