...
namespace DaVinci
{
    class MainViewModel_mik : ViewModelBase_mik
    {
        ...
        {
            Images = new List<BitmapImage>(global::DaVinci.Im.It_artists.mik.ContentProvider_mik.Instance.GetDefaultPictures());
            SetNextImage();
            IsInitialized = true;
        }
